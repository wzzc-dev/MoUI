...
sequence. Provider-created Skia renderers opt into post-present async image
...
provider completion and smoke log rather than matching-host off-main
...
second-frame artifacts remain follow-up work; the Linux package proof covers
host completion/repaint sequencing only. Skia renderer-local
