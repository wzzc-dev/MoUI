...
| AsyncImage | `macos-real-skia` | `linux-real-skia` | `windows-real-skia` | Real second-frame repaint after completion, deferred-completion via HostNativeAsyncImageSource, off-main-thread file I/O via platform C stubs (GCD/pthread/CreateThread) |
