...
class MoUISemanticsCapability internal constructor(
    private val owner: MoUIShellPluginCapabilities,
) {
...
class MoUIShellPluginCapabilities private constructor() {
    ...
    internal fun configure(intent: Intent?): MoUIShellPluginCapabilities {
    ...
    companion object {
        ...
        private val shared = MoUIShellPluginCapabilities()

        internal fun forIntent(intent: Intent?): MoUIShellPluginCapabilities = shared.configure(intent)
    }
}
