...
Environment defaults:
  ...
  SKIA_MBT_SKIA_LINK_MODE, SKIA_MBT_SKIA_PROVIDER,
  SKIA_MBT_RELEASE_OWNER, SKIA_MBT_RELEASE_REPO, SKIA_MBT_RELEASE_TAG,
  SKIA_MBT_RELEASE_URL, SKIA_MBT_JETBRAINS_TAG, SKIA_MBT_SKIA_COMMIT,
...
skia_link_mode="${SKIA_MBT_SKIA_LINK_MODE:-static}"
