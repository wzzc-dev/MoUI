...
SKIA_MBT_SKIA_LIB, SKIA_MBT_SKIA_PROVIDER, SKIA_MBT_SKIA_LINK_MODE,
SKIA_MBT_EXTRA_CC_FLAGS, SKIA_MBT_EXTRA_LINK_FLAGS, and release metadata used
by real-smoke logs.
EOF
}
...
SKIA_MBT_RELEASE_OWNER=$owner
SKIA_MBT_RELEASE_REPO=$repo
SKIA_MBT_RELEASE_TAG=$tag
SKIA_MBT_RELEASE_URL=$release_url
...
SKIA_MBT_SKIA_LINK_MODE=$resolved_link_mode
