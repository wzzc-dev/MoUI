...
- `backend/linux/`: Wayland host over `wzzc-dev/window@0.5.1-0.1.7`, Linux
...
`wzzc-dev/window@0.5.1-0.1.7` package monitor/cursor probe as
...
validates the `wzzc-dev/window@0.5.1-0.1.7` package runtime smoke transcript
