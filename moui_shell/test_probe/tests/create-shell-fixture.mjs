...
const sourceConfig = JSON.parse(readFileSync(
  resolve(repoRoot, `examples/${options.app}/shell.json`),
  "utf8",
));
...
if (options.kind === "plugin-config") {
  sourceConfig.shell.plugins = ["moui_shell/test_probe/moui.plugin.json"];
