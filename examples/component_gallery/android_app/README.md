...
This is an experimental Android shell for the Component Gallery example. The Java
`Activity` owns the `SurfaceView` lifecycle, JNI owns `ANativeWindow` handle
acquisition, and the MoonBit package `examples/component_gallery/android` owns
