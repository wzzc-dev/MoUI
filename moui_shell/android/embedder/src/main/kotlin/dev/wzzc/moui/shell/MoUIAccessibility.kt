...
internal class MoUIAccessibilityBridge(
    ...
    fun update(payload: JSONObject): MoUISemanticsUpdate? {
        ...
        Log.i(LOG_TAG, "moui-shell service accessibility tree nodes=${nodes.size}")
    ...
    override fun performAction(virtualViewId: Int, action: Int, arguments: Bundle?): Boolean {
        ...
        return when (action) {
            AccessibilityNodeInfo.ACTION_ACCESSIBILITY_FOCUS -> {
                ...
                Log.i(LOG_TAG, "moui-shell service accessibility focus id=$virtualViewId")
            ...
            AccessibilityNodeInfo.ACTION_CLICK -> {
                Log.i(LOG_TAG, "moui-shell service accessibility action=activate id=$virtualViewId")
