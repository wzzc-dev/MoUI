...
- M5 Harmony shell: `node scripts/validate-harmonyos-m5-shell.mjs` (no `.onTouch`; XComponent only).
- P1/P2/R3/G1: `node scripts/validate-harness-batch1.mjs` (`--json` for machine summary).
