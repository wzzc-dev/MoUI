...
revisions. Off-main-thread file I/O is implemented via platform C stubs;
real-device smoke verification of off-main-thread completion delivery remains
follow-up work; the Linux package proof covers host completion/repaint
sequencing only. Skia renderer-local
