...
class MoUIActivity : ComponentActivity(), SurfaceHolder.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i(
            LOG_TAG,
            "moui-mobile managed-shell language=kotlin activity=ComponentActivity overlay=FrameLayout",
        )
    }
    ...
    override fun onStop() {
        started = false
        stopFrameLoop()
        Log.i(LOG_TAG, "moui-mobile lifecycle paused reason=stop")
        super.onStop()
    }
    ...
    override fun onDestroy() {
        ...
        if (isFinishing && !isChangingConfigurations) {
            ...
            Log.i(LOG_TAG, "moui-mobile application destroy result=$destroyed")
        }
        super.onDestroy()
    }
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        surfaceView.post {
            ...
            Log.i(
                LOG_TAG,
                "moui-mobile resize width=$width height=$height orientation=${newConfig.orientation}",
            )
        }
    }
    ...
    override fun surfaceCreated(holder: SurfaceHolder) {
        ...
        Log.i(
            LOG_TAG,
            "moui-mobile lifecycle attach width=$width height=$height attached=$attached",
        )
        startFrameLoop()
    }
    ...
    private fun detachSurface(reason: String) {
        ...
        Log.i(LOG_TAG, "moui-mobile lifecycle detach reason=$reason")
    }
