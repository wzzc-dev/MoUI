#ifndef MOUI_EMBEDDING_API_BRIDGE_H
#define MOUI_EMBEDDING_API_BRIDGE_H
...
FOUNDATION_EXPORT const int32_t MOUIShellBridgeErrorIncompatibleABI;

@interface MOUIShellRuntimeDataResult : NSObject
 ...
 */
@interface MOUIShellRuntimeBridge : NSObject

@property(class, nonatomic, readonly) MOUIShellRuntimeBridge *shared;
