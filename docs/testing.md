...
the stable glyph metadata path. New native Skia recordings also preserve and
require fallback script/language-count metadata plus resolved missing-glyph and
