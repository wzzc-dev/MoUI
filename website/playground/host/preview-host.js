export class PreviewHost {
  ...
  async run(wasmBytes) {
    ...
    if (!sources?.runtime || !sources?.browser || !sources?.canvas2d || !sources?.semantics) {
    ...
    const semanticsSource = sourceLiteral(sources.semantics);
