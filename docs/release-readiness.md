...
`HostAsyncImageLoader` hooks around that helper. Focused Skia renderer and
provider tests prove completion scheduling, lifecycle apply, and redraw routing
through the host scheduler; this remains provider/package completion evidence,
not matching-host off-main runtime proof.
