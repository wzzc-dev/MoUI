param(
  ...
  [string] $LinkMode = $(if ($env:SKIA_MBT_SKIA_LINK_MODE) { $env:SKIA_MBT_SKIA_LINK_MODE } elseif ($env:SKIA_MBT_MACOS_LINK_MODE) { $env:SKIA_MBT_MACOS_LINK_MODE } else { "static" }),
