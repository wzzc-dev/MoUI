...
const toolPackage = "tools/moui/validate_conformance_capture_manifest";
const toolExe = join(
  repoRoot,
  "_build/native/debug/build/wzzc-dev/moui_tools/moui/validate_conformance_capture_manifest/validate_conformance_capture_manifest.exe",
);
