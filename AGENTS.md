...
- `backend/host/` defines shared host event, surface, input, async
  host-service, host-event fanout subscription adapters, scheduler-backed timer subscription adapters,
  app-owned service completion subscription adapters, window lifecycle, window scene resolution,
