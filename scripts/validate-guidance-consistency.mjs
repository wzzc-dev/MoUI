...
assertIncludes("docs/testing.md", "WINDOW_MOUI_MACOS_SMOKE_LOG_PATH");
assertIncludes("docs/release-readiness.md", "WINDOW_MOUI_MACOS_SMOKE_LOG_PATH");
assertIncludes("AGENTS.md", "WINDOW_MOUI_MACOS_SMOKE_LOG_PATH");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "WINDOW_MOUI_MACOS_SMOKE_LOG_PATH");
assertIncludes(".github/workflows/ci.yml", "WINDOW_MOUI_MACOS_SMOKE_LOG_PATH");
assertIncludes(".local_repos/window/scripts/check_moui_macos_smoke.sh", "WINDOW_MOUI_MACOS_SMOKE_LOG_PATH");
assertIncludes("scripts/dev-check.sh", "sh -n scripts/record-macos-local-runtime-evidence.sh");
assertIncludes("scripts/record-macos-local-runtime-evidence.sh", "record-native-ime-evidence.mjs");
assertIncludes("scripts/record-macos-local-runtime-evidence.sh", "record-macos-platform-runtime-evidence.mjs");
assertIncludes("scripts/record-macos-local-runtime-evidence.sh", "matching-host-artifact");
assertIncludes("docs/testing.md", "scripts/record-macos-local-runtime-evidence.sh");
assertIncludes("docs/release-readiness.md", "scripts/record-macos-local-runtime-evidence.sh");
assertIncludes("AGENTS.md", "scripts/record-macos-local-runtime-evidence.sh");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "scripts/record-macos-local-runtime-evidence.sh");
...
assertIncludes("docs/testing.md", "exact whitespace-delimited tokens");
...
assertIncludes("docs/release-readiness.md", "fallback request character");
assertIncludes("docs/testing.md", "fallback request character");
assertIncludes("docs/text-system.md", "fallback request character");
assertIncludes("docs/renderer-capability-report.md", "fallback request character");
assertIncludes("docs/text-system.md", "emoji-u+<fallback request character>");
assertIncludes("scripts/validate-renderer-proof-manifest.mjs", "stable-glyph-key");
assertIncludes("scripts/validate-renderer-proof-manifest.mjs", "fallbackRequestCharacter");
...
assertIncludes("docs/release-readiness.md", "selection-rects line-range rect-geometry hit-test");
assertIncludes("scripts/validate-renderer-proof-manifest.mjs", "hit-test");
assertIncludes("scripts/validate-renderer-proof-manifest.mjs", "rect-geometry");
assertIncludes("scripts/record-renderer-proof-manifest.mjs", "hit-test");
assertIncludes("scripts/record-renderer-proof-manifest.mjs", "rect-geometry");
assertIncludes("docs/release-readiness.md", "grapheme-boundary` and `utf8-offsets`");
assertIncludes("docs/testing.md", "UTF-8 offset evidence from host IME diagnostics");
...
assertIncludes("docs/release-readiness.md", "`composition-cursor` evidence");
assertIncludes("docs/testing.md", "`composition-cursor`");
assertIncludes("docs/text-system.md", "`composition-cursor` evidence");
assertIncludes("AGENTS.md", "composition cursor evidence");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "composition cursor evidence");
assertIncludes("scripts/validate-renderer-proof-manifest.mjs", "composition-cursor");
assertIncludes("scripts/record-renderer-proof-manifest.mjs", "composition-cursor");
assertIncludes("scripts/ci-renderer-proof-native.mjs", "composition cursor");
assertIncludes("scripts/ci-renderer-proof-native.sh", "composition cursor");
assertIncludes("moui/tests/skia_text_emoji_smoke/native/main.mbt", "composition cursor");
...
assertIncludes("scripts/record-macos-platform-runtime-evidence.mjs", "--window-smoke-log");
assertIncludes("scripts/record-macos-platform-runtime-evidence.mjs", "--app-runtime-log");
assertIncludes("scripts/record-macos-platform-runtime-evidence.mjs", "examples/showcase/macos_skia");
assertIncludes("moui/backend/macos/macos_backend.mbt", "native_ime_runtime_evidence");
assertIncludes("examples/markdown_editor/macos_skia/main.mbt", "MOUI_MACOS_NATIVE_IME_EVIDENCE");
assertIncludes(".github/workflows/ci.yml", "MOUI_MACOS_NATIVE_IME_EVIDENCE=1");
assertIncludes(".github/workflows/ci.yml", "artifacts/platform-evidence/macos/ime-markdown-runtime.log");
assertIncludes("scripts/record-macos-platform-runtime-evidence.mjs", "macos.skiaEvidence.status must already be passed");
assertIncludes("scripts/test-record-macos-platform-runtime-evidence.mjs", "reject source window smoke log missing cursor probe");
assertIncludes("scripts/test-record-macos-platform-runtime-evidence.mjs", "reject source window smoke log missing IME probe");
assertIncludes("scripts/test-record-macos-platform-runtime-evidence.mjs", "reject source app runtime log with wrong title");
assertIncludes("docs/testing.md", "record-macos-platform-runtime-evidence.mjs");
assertIncludes("docs/testing.md", "MOUI_MACOS_NATIVE_IME_EVIDENCE=1");
assertIncludes("docs/testing.md", "--window-smoke-log");
assertIncludes("docs/testing.md", "--app-runtime-log");
assertIncludes("docs/release-readiness.md", "record-macos-platform-runtime-evidence.mjs");
assertIncludes("docs/release-readiness.md", "MOUI_MACOS_NATIVE_IME_EVIDENCE=1");
assertIncludes("docs/release-readiness.md", "appkit-setMarkedText");
assertIncludes("docs/release-readiness.md", "appkit-insertText");
assertIncludes("docs/renderer-capability-report.md", "macOS-only runtime claim");
assertIncludes("AGENTS.md", "record-macos-platform-runtime-evidence.mjs");
assertIncludes("AGENTS.md", "MOUI_MACOS_NATIVE_IME_EVIDENCE=1");
assertIncludes("AGENTS.md", "NSTextInputClient");
assertIncludes("AGENTS.md", "appkit-firstRectForCharacterRange");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "record-macos-platform-runtime-evidence.mjs");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "MOUI_MACOS_NATIVE_IME_EVIDENCE=1");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "appkit-setMarkedText");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "appkit-insertText");
...
assertIncludes("scripts/record-native-ime-evidence.mjs", "appkit-setMarkedText");
assertIncludes("scripts/record-native-ime-evidence.mjs", "appkit-firstRectForCharacterRange");
assertIncludes("scripts/record-native-ime-evidence.mjs", "appkit-insertText");
assertIncludes("scripts/record-native-ime-evidence.mjs", "platform-protocol=windows-ime");
assertIncludes("scripts/record-native-ime-evidence.mjs", "renderer=skia");
assertIncludes("scripts/record-native-ime-evidence.mjs", "tokenMarker");
...
assertIncludes("scripts/test-record-native-ime-evidence.mjs", "reject macOS IME log without AppKit markers");
assertIncludes("scripts/test-record-native-ime-evidence.mjs", "reject macOS cursor update log without AppKit insert marker");
...
assertIncludes("docs/testing.md", "appkit-firstRectForCharacterRange");
...
assertIncludes("AGENTS.md", "fallback request character");
assertIncludes("AGENTS.md", "fallback-request-character");
assertIncludes("AGENTS.md", "selectionRects");
assertIncludes("AGENTS.md", "selection-rects line-range rect-geometry hit-test");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "fallback request character");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "fallback-request-character");
assertIncludes("skills/moui-framework-development-skill/SKILL.md", "`line-range`, `rect-geometry`, and `hit-test`");
