...
plus Web route/history bridge evidence refreshed on 2026-06-05 and current-head
MoUI CI Web/renderer-proof evidence refreshed on 2026-06-06. The native
SkParagraph binding, renderer route, proof-token gate, and smoke-helper handoff
were refreshed on 2026-06-08; that refresh tightens the native paragraph/bidi
claim but does not mark it ready without new macOS, Windows, and Linux
SkParagraph renderer-proof manifests.
...
3. Emoji and text shaping evidence
   - Current status: Web can rely on browser font rasterization. Native WGPU can
     ...
     offset conversion, and IME `nearest_boundary_utf8_offset` conversion share
     those boundaries. Skia tests now cover the same
     ...
     script/language-count metadata plus missing-glyph recovery metadata,
