...
2. Async image diagnostics
   - Current status: renderer-neutral lifecycle records model loading, ready,
     ...
     revisions, routes redraw requests to the matching open window, and drops
     closed-window image changes; Skia caches failed sources with diagnostics
