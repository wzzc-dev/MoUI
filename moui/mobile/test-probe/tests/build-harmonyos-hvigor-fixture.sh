...
MOUI_MOBILE_SHELL_CI_ROOT="$fallback_root" \
...
native_config="$fallback_root/harmonyos/plugin/native/moui-mobile-harmonyos.cmake"
...
(
  ...
  env \
    ...
    MOUI_MOBILE_NATIVE_CONFIG="$native_config" \
    MOUI_HARMONYOS_FALLBACK=ON \
    MOUI_HARMONYOS_LEGACY_SHELL=OFF \
...
echo "[moui-mobile-test-probe] Wrote Hvigor compiler fixture $output_hap"
