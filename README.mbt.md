...
- render command contracts: `RenderCommandList`, `RenderCommand`, and
  ...
  rounded-rectangle and path clipping, cacheable text-run and shaped glyph-run
  draw commands, explicit shader/filter/image resource declarations, and
  target-bound resource plans for backend caches
