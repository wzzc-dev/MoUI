...
const toolPackage = "tools/moui/validate_platform_evidence_manifest";
const toolExe = join(
  repoRoot,
  "_build/native/debug/build/wzzc-dev/moui_tools/moui/validate_platform_evidence_manifest/validate_platform_evidence_manifest.exe",
);
