...
- The native smoke log passed `scripts/verify-native-smoke-log.*`, including
  ...
  resource-cache insertion and LRU eviction, surface flush-and-submit, shader
  ...
  cache-key variation, font fallback family metadata, font fallback resource
  planning, and shader/filter resource planning.
