...
| `toggle_switch` | `views/controls.mbt` | Color params | Switch | `views/views_test.mbt` | Planned Showcase catalog coverage | Alias-style switch entry point. |
...
| `frame` | `views/frame.mbt` | N/A | Child semantics | `views/views_test.mbt` | Showcase indirectly | Constraint wrapper. |
...
| `stack` / `overlay` | `views/stack.mbt` | Child/modifier based | Children preserved | `views/views_test.mbt` | Dialog host, Tooltip | Overlay layout primitives. |
...
| `grid` | `views/grid_list.mbt` | N/A | Children preserved | `views/views_test.mbt` | Planned Showcase catalog coverage | Fixed-column layout. |
...
| `environment` | `views/theme.mbt` | Creates Environment | N/A | `views/views_test.mbt` | Showcase indirectly | Runtime environment helper. |
