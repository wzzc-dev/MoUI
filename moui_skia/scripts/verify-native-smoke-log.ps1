param(
  ...
  [string] $Marker = "moui_skia native smoke test passed"
)
...
$defaultExpectedStageValues = @(
  ...
  [pscustomobject]@{
    Marker = "native smoke image encode parameters sanitized"
    Value = "1"
  }
  [pscustomobject]@{
    Marker = "native smoke image sampling scalars sanitized"
    Value = "1"
  }
  [pscustomobject]@{
  ...
  [pscustomobject]@{
    Marker = "native smoke shader radial gradient validation"
    Value = "1"
  }
  [pscustomobject]@{
