...
- `web_wasm/`, `macos_skia/`, `macos_wgpu/`, `windows_skia/`,
  `windows_wgpu/`, `windows_wgpu_cosmic/`, `linux_skia/` — thin platform
  entrypoints that construct `MarkdownEditorApp` and run its program.
...
| Windows WGPU Cosmic  | `windows_wgpu_cosmic` | Wired  |
