...
rectangles, and hit-test geometry while keeping native paragraph and bidi
readiness flags false until stronger artifacts exist. The renderer
...
Native SkParagraph/HarfBuzz-grade line breaking, bidi, broader typography,
deterministic color emoji, grapheme shaping, and cross-platform emoji fallback conformance remain
