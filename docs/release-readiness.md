...
Skia image lifecycle callback evidence refreshed on 2026-06-04.
...
2. Async image diagnostics
   ...
   - Done when: native provider/host async loader notification wiring is either
     implemented or explicitly scoped out of the preview handoff.
     Renderer-local diagnostics and callbacks are current, but they do not
     prove a cross-renderer late repaint contract.
