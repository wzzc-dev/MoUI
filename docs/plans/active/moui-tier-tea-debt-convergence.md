...
| 2026-08-04 | Showcase alone covers all 14 routes; other examples keep only applicable Tier 1 entrypoints. |
...
- [x] Non-Showcase UI examples contain only applicable Tier 1 roots.
...
| 2026-08-04 | Replaced the four-path window dependency allowlist with recursive discovery of every repository-owned `moon.mod`; seven consumers resolve `wzzc-dev/window@0.5.4-0.1.4`. |
