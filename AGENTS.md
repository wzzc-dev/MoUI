...
proof until a matching host records passed observations and artifacts. The Web
runtime handoff validator checks static HTML/runtime/wasm delivery for Showcase
