...
`wzzc-dev/window@0.5.1-0.1.7` Linux package for Wayland event-loop and window handles,
...
- Wayland development headers and generated xdg-shell protocol sources for the
  `wzzc-dev/window@0.5.1-0.1.7` native stub.
...
Record dependency-level facts from the `wzzc-dev/window@0.5.1-0.1.7`
